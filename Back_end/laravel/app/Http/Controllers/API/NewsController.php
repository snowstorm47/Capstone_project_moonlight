...
class NewsController extends Controller
{
    ...
    {
        $News=News::join('institution', 'institution.id', '=', 'news.institution_id')->get(['institution.institutionName','institution.image AS profile','news.title','news.body','news.created_at','news.id','news.image']);
