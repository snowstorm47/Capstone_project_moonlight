...
const EditHiringProfilePicture = ({ parentToChild }) => {
  ...
  const handleSubmit = async () => {
    ...
    axios.get("/sanctum/csrf-cookie").then((response) => {
      axios.post(`api/updateHiringCompanyProfilePicture/${id}`, fData).then((response) => {
...
export default EditHiringProfilePicture;
